...
def draw_comparison_parameters(meson, mean, list_data, list_mc, index, cutname, date, period_str, decay):
    ...
    #canvas plotting
        ...
        leg.AddEntry(list_mc[0] , "M.C. rec. #gamma (LHC24b1)","LP");
        leg.Draw("");
        ROOT.SetOwnership(leg,False);
...
def run(filename_data, filename_mc,config,type,folder, period_str, decay):
    ...
    # list_mc[3][0].SetBinContent(1, 0)
    # list_data[3][0].SetBinContent(1, 0)
    ...
    draw_comparison_parameters("pi0", "false", list_data[3], list_mc[3], 3, "FWHM_div_2.36", date, period_str, decay)
...
if __name__ == "__main__":
    ...
    for i in range(len(period_array)):
        ...
        folder = "/Users/juliaschlagel/Analysis240411/Analysis/AlicePCMRun3-main/param_comp_{0}".format(decay)
        os.makedirs(folder, exist_ok=True);
        filename_data = "/Users/juliaschlagel/Analysis240411/Analysis/AlicePCMRun3-main/analysis_results_final_pi0_begin_3/inv_mass_analysis/PCM/this_analysis_pcm_LHC22o_pi0_data_ptspectrum_pp_13.6TeV_LHC22o_AnyTrack.root" #pcm
        # filename_data = "/Users/juliaschlagel/Analysis240411/Analysis/AlicePCMRun3-main/analysis_results_final_pi0_begin_3/inv_mass_analysis/Dalitz/this_analysis_dalitz_LHC22o_pi0_data_ptspectrum_pp_13.6TeV_LHC22o_AnyTrack.root"
        filename_mc = "/Users/juliaschlagel/Analysis240411/Analysis/AlicePCMRun3-main/analysis_results_final_pi0_begin_3/inv_mass_analysis/PCM/this_analysis_pcm_LHC24b1_pi0_mc_ptspectrum_pp_13.6TeV_LHC22o_AnyTrack.root" #pcm
        # filename_mc = "/Users/juliaschlagel/Analysis240411/Analysis/AlicePCMRun3-main/analysis_results_final_pi0_begin_3/inv_mass_analysis/Dalitz/this_analysis_dalitz_LHC24b1_pi0_mc_ptspectrum_pp_13.6TeV_LHC22o_AnyTrack.root"
