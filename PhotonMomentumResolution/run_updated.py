        ...
        if run_type == "both_types":
            ...
            for isys in range(0, nsys):
                ...
                if decay == "dalitz":
                    ...
                    eff_bin_name = os.path.join(folder, "inv_yield_calculation", "Dalitz", "Eff_acc_binomial_{0}".format(ssname))
                else:
                    ...
                    eff_bin_name = os.path.join(folder, "inv_yield_calculation", "PCM", "Eff_acc_binomial_pcm")

                eff_acc = eff_class.eff_and_acc_vs_pt("false", raw_mc, utils_mc, TString(eff_acc_name), "true")
                #eff_acc_bin = eff_class.eff_and_acc_vs_pt_bin("false", raw_mc, utils_mc, TString(eff_bin_name), "true")
                ...
                comp_class.comp_eff_Teff(utils, eff_acc, teff_acc, TString(comp_teff_eff), "true")
        ...
        for dec in range(len(decay_array)):
            ...
            for r in range(len(run_type_array)):
                ...
                for i in range(len(period_array)):
                    ...
                    #if meson == "eta":
                    folder = "/Users/juliaschlagel/Analysis240411/Analysis/AlicePCMRun3-main/analysis_results_final_{0}_begin_{1}".format(meson, start_pt)
