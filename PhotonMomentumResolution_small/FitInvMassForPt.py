...
class PairAnalyzer:
    ...
    def set_2D_histograms(self, outlist):
        ...
        ########################################
        #self.list_ev_ss.ls();
        self.list_ev_ss_af = self.list_ev_ss.FindObject("after");
        self.list_ev_ss_af.ls();
        # self.list_ev_dal = self.list_ev.FindObject("PCMDalitzEE")   #Neu (3 Zeilen)
        # self.list_ev_ss_af = self.list_ev_dal.FindObject("after")
        # self.list_ev_ss_af.ls()
        
        # self.listev_ev_ss_af = self.set_subsystem.list_ev_ss.FindObject("after")
        # self.list_ev_ss_af.ls()
        ...
        h2same.Sumw2();
        h2mix .Sumw2();
        utils = Utility(self.filename, self.config, self.decay, "data")
        nev = utils.get_Nev()
    ...
    def set_2D_histograms_MC(self, outlist):
        ...
        if self.meson == "pi0":      
            ...
            h2mc.RebinX(4);
        h2mc.Sumw2();
        utils = Utility(self.filename, self.config, self.decay, "mc")
        nev = utils.get_Nev()
        #nev = h1ev.GetBinContent(7);
        #print("++++++++++++++++++++++++++++++++++++++++++++++++++NEV = ", nev)
