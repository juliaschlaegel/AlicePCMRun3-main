...
class Save_Hist:
    ...
    def add_histogram(self, folder, histogram, new_name=None):#defining a function to add a histogramm to the list that later will be saved
    ...
    def save_histograms(self): # function to save a histogram in a rootfile
        try:
