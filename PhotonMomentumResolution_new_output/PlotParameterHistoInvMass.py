...
class PlotHistoInvMass:
    ...
    def PlotHistoParameters(self, fHistoParameter,
        ...
        for iParam in range(5):
            ...
            frame = pad.cd(place).DrawFrame(0., yMin_, 15., yMax_);
            ...
            if iParam == 1:
                ...
                if self.meson == "eta":
                    line2 = TLine(0,547.86,12,547.86)
        ...
        if self.meson == "eta":
            txt.AddText("Parameters for asymmetric Gaussian fit on invariant mass of #eta");
        txt.Draw();
        ...
        if self.meson == "eta":
            legendData.AddEntry(line2, "literature value of #it{#eta} mass")
        legendData.Draw();
