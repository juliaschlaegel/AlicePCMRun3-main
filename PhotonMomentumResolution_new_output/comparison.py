...
class Compare:
    ...
    def get_13tev_file(self, filename_comp,hist_comp): #function to open the files from run2 for comparison
    ...
    def compare_13tev_eff_acc_new(self, filename_comp, comp_partner_hist, decay, name_plot, save):
        # This function was made to compare the product of acc and eff by taking the histograms for eff and acc 
        # seperately from the comparison file and not the precalculated histogram
